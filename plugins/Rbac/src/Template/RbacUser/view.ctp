<div class="panel panel-default">
    <div class="panel-heading">
        <span class="pull-right">
            ...
            <a class="btn btn-xs" href="<?= $this->Url->build(['controller' => 'rbacUser', 'action' => 'index']) ?>"><i class="fa fa-list"></i> <?= __('List') ?></a>
        </span>
        <h3 class="panel-title"><i class="fa fa-search-plus"></i> <?= __('Rbac User'); ?></h3>
    </div>
